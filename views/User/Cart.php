...
<body>
    ...
    <?php foreach ($carts as $cart): ?>
            ...
            <div class="col-md-5">
                ...
                <p class="d-flex align-items-center">
                    ...
                    <span class="border rounded-circle d-inline-block ms-2" 
                        style="background: <?= $cart['color_code'] ?>; width: 20px; height: 20px; border: 1px solid #000; vertical-align: middle;">
                    </span>
                </p>
        ...
        <div class="col-md-1">
            <a href="<?= BASE_URL . "?act=order&cart_detail_id=" . $cart['id'] ?>" class="btn btn-primary">Thanh toán</a>
        </div>
    <?php endforeach; ?>
    ...
    <div class="row">
        <div class="col-md-12 text-end">
            <h4><strong>Tổng tiền: <?= number_format($total, 0, ',', '.') ?> VNĐ</strong></h4>
        </div>
    </div>
    ...
    <div class="d-flex justify-content-between mt-4">
        ...
        <a href="<?php echo BASE_URL . "?act=order" ?>" class="btn btn-success">Thanh toán</a>
    </div>
